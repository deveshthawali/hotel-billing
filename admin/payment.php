...
<body>
    <div class="searchsection">
        ...
        <form action="./exportdata.php" method="post" style="display:inline;">
            <button class="btn btn-success" name="exportexcel" type="submit" style="border-radius: 100%;"><i class="fa-solid fa-file-arrow-down"></i></button>
        </form>
    </div>
...
<script>
    // Search bar logic using JavaScript
    const searchFun = () => {
